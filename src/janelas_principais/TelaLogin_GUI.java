...
import janelas_controler.TelaLoginInvalido;
...
public class TelaLogin_GUI extends javax.swing.JFrame {
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        if (ValidarLogin.login()) {
            new janelas_principais.TelaExtrair_GUI().setVisible(true);
            dispose();
        } else {
            new TelaLoginInvalido().setVisible(true);
            janelas_principais.TelaLogin_GUI.pfSenha.setText(""); // LIMPA A SENHA CASO ERRADA
        }
