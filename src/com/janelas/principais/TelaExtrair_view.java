...
import com.controler.GerarArquivos;
import com.controler.SelecionarTabelas;
import java.io.File;
import javax.swing.JOptionPane;

public class TelaExtrair_view extends javax.swing.JFrame {

    public TelaExtrair_view() {
        initComponents();
    ...
    private void btnSairActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSairActionPerformed
        // new janelas_controler.TelaConfirmarSair().setVisible(true);
        System.exit(0);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(TelaExtrair_view.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
